/*
 * ISASupport.h - HIP types and kernel launching support for Triton Nano backend
 * Contains all HIP type definitions and function implementations for driver.c
 */

#ifndef TRITON_NANO_ISA_SUPPORT_H
#define TRITON_NANO_ISA_SUPPORT_H

#define __HIP_PLATFORM_AMD__

/*
 * =============================================================================
 * HIP Type Definitions (must match HIP ABI exactly)
 * =============================================================================
 */
...
/*
 * =============================================================================
 * HIP Symbol Table and Dynamic Loading
 * =============================================================================
 */

/* Path to ISA runtime library (defined in driver.c, replaced at compile time) */
extern const char *isaLibSearchPaths[];
...
static bool initSymbolTable(void) {
  void *lib = NULL;

  int n = sizeof(isaLibSearchPaths) / sizeof(isaLibSearchPaths[0]);
  for (int i = 0; i < n; ++i) {
    void *handle = dlopen(isaLibSearchPaths[i], RTLD_LAZY | RTLD_LOCAL);
    if (handle) {
      lib = handle;
    }
  }
...
static bool extractI32(void *ptr, PyObject *obj) {
  *((int32_t *)ptr) = PyLong_AsLong(obj);
  return PyErr_Occurred() == NULL;
}

static bool extractU32(void *ptr, PyObject *obj) {
  *((uint32_t *)ptr) = PyLong_AsUnsignedLong(obj);
  return PyErr_Occurred() == NULL;
}

static bool extractFP32(void *ptr, PyObject *obj) {
...
static ExtractorTypeIndex getExtractorIndex(PyObject *type) {
  Py_ssize_t len = 0;
...
static bool initDataPtrStr(void) {
  data_ptr_str = PyUnicode_InternFromString("data_ptr");
  return data_ptr_str != NULL;
}

#endif /* TRITON_NANO_ISA_SUPPORT_H */
