...
public:
  ...
  matchAndRewrite(triton::gpu::ConvertLayoutOp op, OpAdaptor adaptor,
    ...
    auto &amdTargInfo =
        static_cast<const mlir::triton::NANO::TargetInfo &>(targetInfo);
    if (!(amdTargInfo.getISAFamily() == NANO::ISAFamily::CDNA4 ||
          amdTargInfo.getISAFamily() == NANO::ISAFamily::GFX1250))
      return failure();
