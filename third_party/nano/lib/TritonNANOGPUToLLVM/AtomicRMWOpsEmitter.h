#ifndef TRITON_THIRD_PARTY_NANO_LIB_TRITONNANOGPUTOLLVM_ATOMICRMWOPSEMITTER_H_
#define TRITON_THIRD_PARTY_NANO_LIB_TRITONNANOGPUTOLLVM_ATOMICRMWOPSEMITTER_H_
...
public:
  AtomicRMWEmitter(const mlir::triton::NANO::TargetInfo &targetInfo,
...
private:
  const mlir::triton::NANO::TargetInfo &targetInfo;
...
#endif // TRITON_THIRD_PARTY_NANO_LIB_TRITONNANOGPUTOLLVM_ATOMICRMWEMITTER_H_
