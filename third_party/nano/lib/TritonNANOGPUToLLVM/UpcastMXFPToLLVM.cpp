...
using ::mlir::LLVM::NANO::upcast8xMxfp4_SW;

namespace {

SmallVector<Value> upcastMxfp4_SW(RewriterBase &rewriter,
                                  nanogpu::UpcastMXFPOp upcastOp, bool toFp16,
...
Value mxfpScaleFp16(RewriterBase &rewriter, Location loc, Value v, Value scale,
  ...
  Value scaleF16 =
      LLVM::NANO::cvtFp32ToFp16RTNE_oneValue(loc, rewriter, scaleF32);
...
static void upcast8xMxfp4(RewriterBase &rewriter, Location loc,
                          NANO::ISAFamily isaFamily, nanogpu::UpcastMXFPOp op,
  ...
  /// fp4->bf16 for cdna3
  if (isaFamily == NANO::ISAFamily::CDNA3 && !useFp16) {
...
static void upcast4xMxfp8(RewriterBase &rewriter, Location loc,
                          NANO::ISAFamily isaFamily, ArrayRef<Value> xVals,
...
class UpcastMXFPOpPattern
    : public ConvertOpToLLVMPattern<nanogpu::UpcastMXFPOp> {
private:
...
public:
  ...
  LogicalResult
  matchAndRewrite(nanogpu::UpcastMXFPOp op, OpAdaptor adaptor,
