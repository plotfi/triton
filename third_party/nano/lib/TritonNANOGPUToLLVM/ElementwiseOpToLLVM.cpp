...
ConverterT Fp16_to_Fp8E5M2_RTNE(NANO::ISAFamily isaFamily) {
...
ConverterT Fp16_to_Fp8E4M3FN_RTNE(NANO::ISAFamily isaFamily) {
...
ConverterT Fp32_to_Fp8E4M3FN_RTNE(NANO::ISAFamily isaFamily) {
...
ConverterT Fp32_to_Fp8E5M2_RTNE(NANO::ISAFamily isaFamily) {
...
ConverterT Fp32_to_Fp8E5M2FNUZ(NANO::ISAFamily isaFamily) {
  return isaFamily == NANO::ISAFamily::CDNA3 ? Fp32_to_Fp8E5M2FNUZ_HW
...
static ConverterT Fp32_to_Fp8E4M3FNUZ(NANO::ISAFamily isaFamily) {
...
ConverterT Fp16_to_Fp8E5M2FNUZ(NANO::ISAFamily isaFamily) {
  return isaFamily == NANO::ISAFamily::CDNA3 ? Fp16_to_Fp8E5M2FNUZ_HW
...
ConverterT Fp8E4M3FN_to_Fp16(NANO::ISAFamily isaFamily) {
...
ConverterT Fp8E5M2_to_Fp16(NANO::ISAFamily isaFamily) {
...
Fp8E5M2FNUZ_to_Fp16_HW(Location loc, ConversionPatternRewriter &rewriter,
  ...
  for (size_t i = 0; i < 4; i++)
    ret[i] = LLVM::NANO::cvtFp32ToFp16RTNE_oneValue(loc, rewriter, ret[i]);

  return ret;
}

ConverterT Fp8E5M2FNUZ_to_Fp16(NANO::ISAFamily isaFamily) {
  return isaFamily == NANO::ISAFamily::CDNA3 ? Fp8E5M2FNUZ_to_Fp16_HW
...
ConverterT Fp8E5M2_to_Bf16(NANO::ISAFamily isaFamily) {
...
static ConverterT Bf16_to_Fp8E5M2(NANO::ISAFamily isaFamily) {
...
ConverterT Bf16_to_Fp8E4M3FN(NANO::ISAFamily isaFamily) {
...
ConverterT Fp8E4M3FN_to_Bf16(NANO::ISAFamily isaFamily) {
...
static ConverterT Fp8E4M3FNUZ_to_Bf16(NANO::ISAFamily isaFamily) {
...
static ConverterT Bf16_to_Fp8E4M3FNUZ(NANO::ISAFamily isaFamily) {
...
static ConverterT Bf16_to_Fp8E5M2FNUZ(NANO::ISAFamily isaFamily) {
...
static ConverterT Fp8E4M3FNUZ_to_Fp16(NANO::ISAFamily isaFamily) {
  return isaFamily == NANO::ISAFamily::CDNA3 ? Fp8E4M3FNUZ_to_Fp16_HW
...
static ConverterT Fp16_to_Fp8E4M3FNUZ(NANO::ISAFamily isaFamily) {
  return isaFamily == NANO::ISAFamily::CDNA3 ? Fp16_to_Fp8E4M3FNUZ_HW
  ...
  SmallVector<Value> createDestOps(triton::FpToFpOp op, OpAdaptor adaptor,
    ...
    if ((llvm::isa<Float32Type>(srcElementType) &&
        ...
        (llvm::isa<Float32Type, Float16Type>(srcElementType) &&
         ...
         isaFamily != NANO::ISAFamily::CDNA3) ||
    ...
    if (useFP16IntermediateSrc) {
      if (isCDNA4(isaFamily))
        ...
        for (Value &v : inVals)
          v = LLVM::NANO::cvtFp32ToFp16RTNE_oneValue(loc, rewriter, v);
      }
    }
