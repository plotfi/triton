...
struct ConcatOpConversion : public ConvertOpToLLVMPattern<nanogpu::ConcatOp> {
  using ConvertOpToLLVMPattern::ConvertOpToLLVMPattern;

  LogicalResult
  matchAndRewrite(nanogpu::ConcatOp op, OpAdaptor adaptor,
    ...
    for (int regId = 0; regId < dstRegNum; ++regId) {
      ...
      auto multiDimOperandIdx =
          LLVM::NANO::multiDimElementwise<int32_t, int64_t>(
