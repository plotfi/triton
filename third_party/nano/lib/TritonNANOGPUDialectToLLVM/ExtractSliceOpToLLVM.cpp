...
struct ExtractSliceOpConversion
    : public ConvertOpToLLVMPattern<nanogpu::ExtractSliceOp> {
  using ConvertOpToLLVMPattern::ConvertOpToLLVMPattern;

  LogicalResult processLayout(nanogpu::ExtractSliceOp op, OpAdaptor adaptor,
  ...
  LogicalResult
  matchAndRewrite(nanogpu::ExtractSliceOp op, OpAdaptor adaptor,
