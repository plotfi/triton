#ifndef TRITON_THIRD_PARTY_NANO_INCLUDE_UTILS_COMMONUTILS_H_
#define TRITON_THIRD_PARTY_NANO_INCLUDE_UTILS_COMMONUTILS_H_
...
#endif // TRITON_THIRD_PARTY_NANO_INCLUDE_UTILS_COMMONUTILS_H_
