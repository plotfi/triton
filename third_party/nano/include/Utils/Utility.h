#ifndef TRITON_THIRD_PARTY_NANO_INCLUDE_UTILS_UTILITY_H_
#define TRITON_THIRD_PARTY_NANO_INCLUDE_UTILS_UTILITY_H_
...
#endif // TRITON_THIRD_PARTY_NANO_INCLUDE_UTILS_UTILITY_H_
